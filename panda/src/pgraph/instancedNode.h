 ...
 *
 * For best performance, it is recommended to remove transforms between this
 * node and the root node (using flatten_light(), for example), and also to
 * flatten the nodes under this (by calling flatten_strong()).
 *
 * Furthermore, disabling culling under this node may also be beneficial, by
 * calling set_final(true).
 *
 * @since 1.11.0
 */
