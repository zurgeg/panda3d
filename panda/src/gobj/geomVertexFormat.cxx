...
get_post_instanced_format() const {
  ...
  if (_post_instanced_format == nullptr) {
    ...
    PT(GeomVertexArrayFormat) new_array_format = new GeomVertexArrayFormat("net_transform", 4, NT_stdfloat, C_matrix);
    new_format->add_array(GeomVertexArrayFormat::register_format(new_array_format));
